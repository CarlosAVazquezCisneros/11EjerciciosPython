...
print("Por favor, elige una canción del 1 al 10:")
for key, value in canciones.items():
    print(key + ". " + value)
eleccion = input("Ingresa el número de la canción que deseas: ")

if eleccion in canciones.keys():
    print("\nLetra de la canción seleccionada:\n" + canciones[eleccion])
else:
    print("Selección no válida. Por favor, elige un número del 1 al 10.")